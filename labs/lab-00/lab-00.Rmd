...
nums <- c(18, 6, 20, 2, NA) #Extend if necessary
colours <- c("powderblue", "Violet", "babypink", "colour 2", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "Dance", "horseriding", "Hobby 3", "Hobby 4") #Extend if necessary
