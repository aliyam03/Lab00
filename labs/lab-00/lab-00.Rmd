...
```{r setup-tibble}
usernames <- c("wilsonamy", "leahc04b", "aliyam03", "sophie2404", "username 4") #Extend if necessary 
nums <- c(18, NA, 20, NA, NA) #Extend if necessary
colours <- c("powderblue", "Colour 1", "babypink", "colour 2", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "Hobby 1", "horseriding", "Hobby 3", "Hobby 4") #Extend if necessary
